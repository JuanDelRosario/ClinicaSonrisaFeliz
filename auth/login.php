    ...
    <div class="login-container">
        ...
        <div class="login-info">
            <div class="info-content">
                ...
                <ul class="features">
                    <li><span class="feature-icon">✓</span>Gestión de Pacientes</li>
                    <li><span class="feature-icon">✓</span>Programación de Citas</li>
                    <li><span class="feature-icon">✓</span>Registro de Consultas</li>
                    <li><span class="feature-icon">✓</span>Control de Facturación</li>
                    <li><span class="feature-icon">✓</span>Historial Médico</li>
                    <li><span class="feature-icon">✓</span>Reporte de Ingresos</li>
                </ul>
                <div class="contact-info">
                    <p><span class="contact-icon">📞</span>+1 (849) 282-5216</p>
                    <p><span class="contact-icon">📧</span>info@clinicasonrisafeliz.com</p>
                    <p><span class="contact-icon">🏥</span>Villa Mella, Vista Bella - Santo Domingo Norte</p>
                </div>
            </div>
        </div>
    </div>
